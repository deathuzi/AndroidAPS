...
enum class BooleanKey(
    ...
    ApsDisableCgmWhitelistForSmb(
        "smb_disable_cgm_whitelist",
        false,
        R.string.pref_title_smb_disable_cgm_whitelist,
        R.string.pref_summary_smb_disable_cgm_whitelist,
        defaultedBySM = true
    ),
    ApsAllowRecalculatedBg(
        "allow_recalculated_bg",
        false,
        R.string.pref_title_allow_recalculated_bg,
        R.string.pref_summary_allow_recalculated_bg,
        defaultedBySM = true
    ),
